...
<body>
		...
		<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">AdminKit</span>
              ...
              <i class="align-middle" data-feather="plus"></i> <span class="align-middle">Create</span>
                    ...
                    <li class="sidebar-item {{request()->routeIs(['product.review', 'product.pageEdit'])?'active': ''}}">
						<a class="sidebar-link" href="{{route('product.review')}}">
              ...
              <i class="align-middle" data-feather="list"></i> <span class="align-middle">Create</span>
            </a>
					</li>
           ...
           <span class="text-dark">Charles Hall</span>
							...
							<div class="dropdown-menu dropdown-menu-end">
								...
								<form action="{{route('logout')}}" method="POST">
                                    @csrf
                                    <input type="submit" value="LogOut" class="ms-5 btn btn-outline-danger" >
                                </form>
							</div>
						</li>
					</ul>
	...
	<script>
		let contenedor = document.querySelector(".list-group")
		setInterval(async() => {
			contenedor.innerHTML = ""
			let nuevanoti = await(await fetch ("/obtener/compras")).json()
			nuevanoti.forEach((noti) => {
				contenedor.innerHTML+= `	<a href="#" class="list-group-item">
										<div class="row g-0 align-items-center">
											<div class="col-2">
												<i class="text-danger" data-feather="shopping-bag"></i>
											</div>
											<div class="col-10">
												<div class="text-dark">${noti.tipo}</div>
												<div class="text-muted small mt-1">${noti.mensaje}</div>
												<div class="text-muted small mt-1">${noti.created_at}</div>
											</div>
										</div>
									</a>`
			})
